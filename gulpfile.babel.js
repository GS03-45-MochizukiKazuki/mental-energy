...
gulp.task('jade-php', () => {
    ...
    return gulp.src(`${SRC}/jade/assets/**/*.jade`)
        .pipe(jade({
            locals: locals,
            pretty: true
        }))
...
gulp.task('php', gulp.series('jade-php'));
...
gulp.task('browser-sync', () => {
    ...
    ], gulp.series('jade-php', browserSync.reload));
});
...
// default
gulp.task('build', gulp.parallel('css', 'js', 'html', 'php'));
